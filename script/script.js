...
function updateTimer() {
    const targetDate = new Date("january 17, 2025 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '543813658048'; // Número para el primer botón
    const recipientNumber2 = '543816380755'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function() {
    // Definir los números de teléfono
    const phoneNumber1 = '543813658048'; // Número para el primer botón
